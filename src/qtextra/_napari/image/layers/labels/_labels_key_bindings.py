# from qtextra._napari.layers.labels import Labels
from napari.layers.labels._labels_constants import Mode
from napari.layers.labels.labels import Labels


@Labels.bind_key("Space", overwrite=True)
...
@Labels.bind_key("Control", overwrite=True)
...
@Labels.bind_key("Alt", overwrite=True)
