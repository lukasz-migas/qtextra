...
class QtScaleBarControls(QtFramelessPopup):
    ...
    def make_panel(self) -> QFormLayout:
        ...
        self.colored_checkbox.stateChanged.connect(self.on_change_colored)
        ...
        self.pixel_size = hp.make_double_spin_box(self, minimum=1, maximum=1000, step_size=5)
    ...
    def on_change_unit(self, _event=None):
        """Update dimension."""
