...
@Shapes.bind_key("Control-V", overwrite=True)
def paste(layer):
...
@Shapes.bind_key("A", overwrite=True)
...
@Shapes.bind_key("Backspace", overwrite=True)
def delete_selected(layer):
    """Delete any selected shapes."""
    layer.remove_selected()


@Shapes.bind_key("Escape", overwrite=True)
