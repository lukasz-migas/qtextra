...
SHOW_HOSTNAME = os.getenv("QTEXTRA_TELEMETRY_SHOW_HOSTNAME", "0") in ("1", "True")
SHOW_LOCALS = os.getenv("QTEXTRA_TELEMETRY_SHOW_LOCALS", "1") in ("1", "True")
DEBUG = bool(os.getenv("QTEXTRA_TELEMETRY_DEBUG"))
PACKAGE = bool(os.getenv("QTEXTRA_TELEMETRY_PACKAGE", "qtextra"))
...
def _get_tags() -> dict:
    ...
    with suppress(ModuleNotFoundError, ImportError):
        tags["editable_install"] = str(is_editable_install("ionglow"))
