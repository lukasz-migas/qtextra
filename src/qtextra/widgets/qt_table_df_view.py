...
class QtDataFrameWidget(Qw.QWidget):
    ...
    def __init__(self, df, inplace=True, parent=None):
        ...
        self.gridLayout.addItem(Qw.QSpacerItem(0, 0, Qw.QSizePolicy.Expanding, Qw.QSizePolicy.Expanding), 0, 0, 1, 1)
...
class HeaderView(Qw.QTableView):
    ...
    def __init__(self, parent: QtDataFrameWidget, df, orientation):
        super().__init__(parent)
